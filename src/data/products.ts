...
export const products: Product[] = [
  {
    ...
    buyingOptions: [
      ...
      },
      {
        id: "sharing-box",
        label: "Sharing Box",
        quantityLabel: "12 large cookies",
        price: 90,
        salePrice: 75,
        batchPortion: 0.5,
      },
  ...
  },
  {
    ...
    storage:
      "Keep refrigerated for 4 days or freeze for up to 6 months.",
    leadTime: "2 days notice",
    status: "active",
    featured: true,
